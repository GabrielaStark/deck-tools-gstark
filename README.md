...
| `stark-nuevo` | Arrancar un proyecto desde cero. Clona stark, le corta el `.git` para que nunca puedas pushear al repo de stark, e inicia el repo del proyecto nuevo. | ⏳ pendiente |
